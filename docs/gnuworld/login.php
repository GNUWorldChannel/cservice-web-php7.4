...
if ($username != "" && $password != "") {
	...
	if ($user_id > 0) {
		...
		if (is_email_locked($LOCK_LOGIN, $rooo->email)) {
			...
			echo "You will need to <b>/join #Help</b> in order to deal with this problem.";
			echo "</body></html>\n\n";
			die;
		}
...
echo "<font size=+2><b>Borischin CService Login</b></font>\n";
...
echo "<table border=0><tr><td><font color=\"#" . $cTheme->main_textcolor . "\">Username</td><td><input class='username-web' type=text name=username value=\"" . $username . "\"></td></tr>\n";
echo "<tr><td><font color=\"#" . $cTheme->main_textcolor . "\">Password</td><td><input class='password-web' type=password name=password></td></tr></table>\n";
