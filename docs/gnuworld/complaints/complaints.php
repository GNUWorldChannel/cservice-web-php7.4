...
?>
<div class="form-complaints">
<table border=0 cellspacing=0 cellpadding=3>
<tr>
<td valign=top><img class="comp-img" border=0 alt=" * ! B O O M ! *" src=complaint_dpt.jpg></td>
<td valign=top>
...
?>
<form id="compaints" name=complaint method=get>
<select id="complaint-select" name=ct>
...
if ($user_id>0) { echo "&nbsp;"; } else {
	echo "<br><input class='c-email' type=text name=email size=30 maxlength=255>&nbsp;e-mail address<br>\n";
	echo "<input class='c-email' type=text name=email2 size=30 maxlength=255>&nbsp;e-mail address again (confirmation)<br>\n";
