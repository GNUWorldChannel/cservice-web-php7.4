...
echo "<tr><td>\n";
echo "<div cellpadding=5 id='login-box-in'>\n";
echo "<tr><td><center>\n";
echo "<font color=#" . $cTheme->main_textcolor . ">\n";
echo "<font size=+2><b>W login</b></font>\n";
echo "<form method=post action=login.php" . $tgt . " target=body>\n";
echo "
<div id='login-box2'>

<font color=\"#" . $cTheme->main_textcolor . "\">
<div class='login-box-user'>
	<p><i class='fa fa-user'></i> Username</p>
	<input class='username-web' type=text name=username value=\"";
...
<div class='login-box-pass'>
	...
	<input class='password-web' type=password name=password>
</div>
</div>\n";
echo "<br><input class='btn' type=submit value=Login>\n";
echo "</center>";
if (PREFILL_NOTICE && trim($_COOKIE['rlogin']) != "") {
	echo "<br><table border=0 cellspacing=0 cellpadding=2 bgcolor=#ffff99>";
	echo "<tr><td valign=top class='text-warning'>";
	echo "<font style=\"font-size: 13px; color: #000000;\">";
	echo "For security reasons, the last username to login to the [ W ] page from this computer is displayed in the login form.";
	echo "<br></td></tr></table>\n";
}
echo "</form>";
?>
